...
gAa,gAn,gBa,gBn,delta,start=0.010,0.012,0,0.001,0.05,0.5
...
axs[0, 0].plot(la[posicion:140], color='red', label='Datos Modelo-la',alpha=0.5)
...
axs[0, 1].plot(ln[posicion:140], label='Datos Modelo-ln', color='red',alpha=0.5)
...
axs[1, 0].plot(kaknmodel[posicion:140], label='Datos Modelo-ka/kn',color='red',alpha=0.5)
axs[1, 0].set_title('RATIO CAPITALES SECTORIALES')
t=[0,20,40,60,80]
...
axs[1, 1].plot(pamodel[posicion:140], label='Datos Modelo-pa/pn', color='red',alpha=0.5 )
axs[1, 1].set_title('RATIO PRECIOS SECTORIALES')
t=[0,20,40,60,80]
...
axs[2, 0].plot(gdpindex[posicion:140], label='Datos Modelo-y',color='red',alpha=0.5 )
axs[2, 0].set_title('EVOLUCIÓN PRODUCCIÓN index la=0,25')
t=[0,20,40,60,80]
...
# SEXTO SUBPLOT
axs[2, 1].plot(vaava, label='Datos Reales-vaagr',alpha=0.8)
axs[2, 1].plot(sharagr[posicion:140], label='Datos Modelo-vaagr', color='red',alpha=0.5 )
axs[2, 1].set_title('VALOR AÑADIDO SECTOR AGRÍCOLA')
t=[0,20,40,60,80]
...
axs[0, 0].set_title('VALOR AÑADIDO SECTOR AGRÍCOLA')
